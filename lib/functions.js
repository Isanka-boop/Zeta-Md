...
const getBuffer = async(url, options) => {
	try {
		...
		console.log(e)
		// IMPORTANT: re-throw so callers' try/catch around getBuffer()
		// actually fires. Previously this swallowed the error and
		// returned undefined, which meant every "catch { fallback }"
		// pattern in the plugins silently received undefined instead
		// of falling back — causing hangs/failed sends further down
		// the line (e.g. Baileys media upload stalling on bad data).
		throw e
	}
}
